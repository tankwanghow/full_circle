---
name: qr-gate-punch
description: Use when working on QR gate attendance — paired Android scanners, building or installing the android/qr_gate APK, POST /api/punch/attendances, punch_devices, fcqa: badge QR, audit face photos on time_attendences, Punch IO photo link, shift-instance punch_kind/flag rebuild after a gate punch, or a punch that is missing from Punch IO — punch_ingest_logs, ingest outcomes and reasons, revoked-device 401s.
---
