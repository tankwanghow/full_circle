    ...
    <div class="w-11/12 mx-auto">
        ...
        <div id="transactions">
          <%= for obj <- @objects do %>
            <div class="flex flex-row text-center tracking-tighter">
              ...
              <div class="w-[12%] border rounded bg-green-200 border-green-400 text-center px-2 py-1">
                <%= obj.doc_type %>
              </div>
              <div class="w-[40%] border rounded bg-green-200 border-green-400 px-2 py-1">
                <%= obj.particulars %>
              </div>
              <div class="w-[13%] border rounded bg-green-200 border-green-400 text-center px-2 py-1">
      ...
      <div id="footer">
        <div class="flex flex-row text-center tracking-tighter mb-5 mt-1">
          ...
          <div class="w-[13%] font-bold border rounded bg-lime-200 border-lime-400 text-center px-2 py-1">
