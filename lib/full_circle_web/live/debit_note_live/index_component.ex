defmodule FullCircleWeb.DebitNoteLive.IndexComponent do
  ...
  defp refresh_self(doc_id, socket) do
    ...
    |> assign(
      obj:
        FullCircle.DebCre.get_debit_note_by_id_index_component_field!(
          doc_id,
          socket.assigns.company,
          socket.assigns.user
        )
  ...
  def render(assigns) do
    ...
    <div
      id={@id}
      class={"#{@ex_class} border-b border-gray-400 flex flex-row tracking-tighter bg-gray-200 hover:bg-gray-400"}
    >
      <div class="w-[2%] py-1 mt-2">
        <input
        ...
        <div class="text-sm">
          ...
          <% else %>
            <.doc_link
              ...
              doc_obj={%{doc_type: "DebitNote", doc_id: @obj.id, doc_no: @obj.note_no}}
            />
