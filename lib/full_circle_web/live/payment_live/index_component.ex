defmodule FullCircleWeb.PaymentLive.IndexComponent do
  ...
  def render(assigns) do
    ...
    <div
      id={@id}
      class={"#{@ex_class} border-b border-gray-400 flex flex-row text-center tracking-tighter bg-gray-200 hover:bg-gray-400"}
    >
      ...
      <div class="w-[15%] py-1 text-left">
        <div>
          ...
          <span :if={!@obj.old_data} class="text-sm">
            <.link
              navigate={~p"/companies/#{@obj.company_id}/Payment/#{@obj.id}/edit"}
