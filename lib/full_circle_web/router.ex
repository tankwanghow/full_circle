defmodule FullCircleWeb.Router do
  ...
  scope "/companies/:company_id", FullCircleWeb do
    ...
    live_session :require_authenticated_user_n_active_company,
      ...
      live("/trading/warehouse_board", TradingDeskLive.Index, :index)
      live("/trading/open_sales", TradingDeskLive.Index, :index)
      live("/trading/supply_positions", TradingDeskLive.Index, :index)
      live("/trading/sales_positions", TradingDeskLive.Index, :index)
      live("/trading/trips", TradingDeskLive.Index, :index)

      # Create/edit deep links → desk + modal (same LiveView)
      live("/trading/supply_positions/new", TradingDeskLive.Index, :new_supply)
      live("/trading/supply_positions/:id/edit", TradingDeskLive.Index, :edit_supply)
      live("/trading/sales_positions/new", TradingDeskLive.Index, :new_sales)
      live("/trading/sales_positions/:id/edit", TradingDeskLive.Index, :edit_sales)
      live("/trading/trips/new", TradingDeskLive.Index, :new_trip)
      live("/trading/trips/:id/edit", TradingDeskLive.Index, :edit_trip)
      ...
      live("/queries/new", QueryLive.Form, :new)
      live("/queries/:query_id/edit", QueryLive.Form, :edit)
