defmodule FullCircleWeb.UserAuth do
  ...
  def log_out_user(conn) do
    ...
    user_token && UserAccounts.delete_user_session_token(user_token)
  ...
  the current_user:
      ...
      defmodule FullCircleWeb.PageLive do
  ...
  Or use the `live_session` of your router to invoke the on_mount callback:
      ...
      live_session :authenticated, on_mount: [{FullCircleWeb.UserAuth, :ensure_authenticated}] do
  ...
  defp mount_current_user(session, socket) do
    Phoenix.Component.assign_new(socket, :current_user, fn ->
      if user_token = session["user_token"] do
        UserAccounts.get_user_by_session_token(user_token)
      end
    end)
  end
