defmodule FullCircle.Tax.RemedyTest do
  ...
  describe "estimate_position/3" do
    test ":under when estimate below floor and forecast above ceiling" do
      assert Remedy.estimate_position(d("6005257.3344"), d(3_825_000), d(30)) == :under
    end

    test ":over when forecast below estimate but not under" do
      assert Remedy.estimate_position(d(400_000), d(500_000), d(30)) == :over
    end

    test ":within when estimate near forecast" do
      assert Remedy.estimate_position(d(100_000), d(90000), d(30)) == :within
    end
  end
  ...
  describe "penalty_analysis/4" do
    test "Kim Poh FY2025 under-estimation figures" do
      ...
      assert Decimal.equal?(a.penalty_ceiling, d(4_972_500))
    end

    test "no penalty when within tolerance" do
      a = Remedy.penalty_analysis(d(130_000), d(100_000), d(30), d(24))
  ...
  describe "under_remedy_comparison/5" do
    test "Kim Poh: 1 director — penalty is cheaper" do
      a = Remedy.penalty_analysis(d("6005257.3344"), d(3_825_000), d(30), d(24))
    ...
    test "existing income raises personal tax" do
      ...
      c1 = Remedy.under_remedy_comparison(a, d(24), 1, d(360_000))
  ...
  describe "over_analysis/4" do
    test "computes overpayment and expected refund" do
      a = Remedy.over_analysis(d(400_000), d(500_000), d(30), d(480_000))

      assert a.position == :over
      assert Decimal.equal?(a.overpayment_tax, d(100_000))
    ...
    test "headroom_tax before crossing into penalty zone" do
      a = Remedy.over_analysis(d(400_000), d(500_000), d(30), d(500_000))
      assert Decimal.equal?(a.headroom_tax, d(250_000))
    end
  end
  ...
  describe "over_remedy_comparison/1" do
    test "suggests revising the estimate down" do
      ...
      assert Decimal.equal?(c.overpayment_tax, d(100_000))
      assert Decimal.equal?(c.expected_refund, d(100_000))
    end
  end
end
